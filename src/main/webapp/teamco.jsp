...
<nav class="navbar-default navbar-fixed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span></a><h4 class="navbar-text">进行中的项目</h4>
            <ul class="dropdown-menu">
                ...
                <li><a id="btn_bussiness" class="btn-flow"><span class="glyphicon glyphicon-plus" aria-hidden="true"> 创建企业</span></a></li>
            </ul>
        </div>

        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li><a id="btn_notification" class="btn-flow"><span class="glyphicon glyphicon-bell" aria-hidden="true"></span> 通知</a></li>
                <li><a id="btn_chats" class="btn-flow"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> 聊天</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a id="btn_self" class="btn-flow">个人信息</a></li>
                        <li><a id="btn_notificationItems" class="btn-flow">通知选项</a></li>
                        <li><a id="btn_setting" class="btn-flow">设定</a></li>
                        <li role="separator" class="divider"></li>
